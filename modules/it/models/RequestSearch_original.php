...
class RequestSearch extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            [['keterangan', 'catatan', 'tanggal_permintaan', 'diketahui_oleh', 'tanggal_persetujuan', 'diterima_oleh', 'tanggal_terima', 'perkiraan_selesai', 'tanggal_selesai', 'pelaksana', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'safe'],
        ];
    }
